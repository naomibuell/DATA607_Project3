...
## Clean and Tidy Salary

1- find what rows are missing salary ranges 2- find what fields have salary information 3- split the salary column into 2 columns for range 4- move salary information for the rows that contain the information in other rows 5- reformat the hourly wages to salary numbers

### Step 1: Find what rows are missing salary information
...
### Step 2: Find what fields have salary ranges
...
### Step 3: split the salary column into 2 columns for range
...
### Step 4: move salary information for the rows that contain the information in other rows
...
### Step 5: reformat the hourly wages to salary numbers
...
ggplot(jobs.skills, aes(x = fct_infreq(value))) +
  geom_bar() +
  coord_flip() +
  labs(x = "skill")
```
